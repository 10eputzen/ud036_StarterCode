...
bill_ted = media.Movie("Bill & Ted's Excellent Adventure",
                       ...
                       "/MV5BMTk3Mjk5MzI3OF5BMl5BanBnXkFtZTcwMTY4MzcyNA@@._V1_UX182_CR0,0,182,268_AL_.jpg",
                       "https://www.youtube.com/watch?v=sFy17auuK08")

deadpool = media.Movie("Deadpool",
                       "2016",
                       "A fast-talking mercenary with a morbid sense of humor is subjected to a rogue experiment that "
...
blues = media.Movie("The Blues Brothers",
                    "1980",
                    "Jake Blues, just out from prison, puts together his old band to save the Catholic home where he "
                    "and brother Elwood were raised.",
                    "https://images-na.ssl-images-amazon.com/images/M"
                    "/MV5BMzdhOTJmYmQtMmE0OS00ZDMyLWFkZDItZmZmMGJlNGUyNjNhXkEyXkFqcGdeQXVyNDk3NzU2MTQ@._V1_UX182_CR0,"
                    "0,182,268_AL_.jpg",
                    "https://www.youtube.com/watch?v=2HCR4c1zPyk")

gump = media.Movie("Forrest Gump",
                   "1994",
                   "While not intelligent, Forrest Gump has accidentally been present at many historic moments, "
                   "but his true love, Jenny Curran, eludes him.",
                   "https://images-na.ssl-images-amazon.com/images/M"
                   "/MV5BYThjM2MwZGMtMzg3Ny00NGRkLWE4M2EtYTBiNWMzOTY0YTI4XkEyXkFqcGdeQXVyNDYyMDk5MTU@._V1_UY268_CR10,"
                   "0,182,268_AL_.jpg",
...
spencer = media.Movie("2 ausser Rand und Band",
                      "1977",
                      "An attempted robbery turns to be an unexpected recruitment when two unemployed men mistakenly "
                      "break into a police office instead of a store.",
                      "https://images-na.ssl-images-amazon.com/images/M"
